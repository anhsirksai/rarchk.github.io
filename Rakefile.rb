...
task :new_post, :title do |t, args|
  ...
  feature = get_stdin("Header image title: ")
  comments = get_stdin("Comments Enalble: Y/n")
  share = get_stdin("Share Enalble: Y/n")
  if share == 'n'
  	shareR = String.new("")
  else
  	shareR = String.new("True")
  end

  if comments == 'n'
  	commentsR = String.new("")
  else
  	commentsR = String.new("True")
  end
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "comments: #{commentsR}"
    post.puts "share: #{shareR}"
...
url = "https://api.github.com/users/rarchk/repos"
file = "repos.json"
